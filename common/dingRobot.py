...
def generate_sign():
    ...
    # 钉钉机器人中的加签密钥
    secret = 'SEC68535ecf838ee49344164723bb61e7032a6e3f3042f638b89039ebf34d445337'
...
def send_dd_msg(content_str, at_all=True):
    ...
    # url = f'https://oapi.dingtalk.com/robot/send?access_token=87bbf28b9c369e886a1f7d746b8abf5e9d3c0acd0894d20ecd2345c083035482={timestamp_and_sign[0]}&sign={timestamp_and_sign[1]}'
    timestamp, sign = generate_sign()

    url = (
        "https://oapi.dingtalk.com/robot/send"
        "?access_token=87bbf28b9c369e886a1f7d746b8abf5e9d3c0acd0894d20ecd2345c083035482"
